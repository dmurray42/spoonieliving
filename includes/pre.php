...
<button onclick="scrollToTop()" id="scroll-top-btn" title="Scroll to top">Top</button>
						...
						<div id="navigation" class="navbar navbar-default" role="navigation">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									...
									<!-- Navigation items -->
									<li class="nav-item"><a href="http://www.spoonieliving.com">Welcome</a></li>
									...
									<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog<b class="caret"></b></a>
										...
										<ul class="dropdown-menu">
											...
											<li><a href="http://blog.spoonieliving.com/tagged/original+content">Original Content</a></li>
											...
											<li><a href="http://blog.spoonieliving.com/tagged/self+care">Self Care</a></li>
